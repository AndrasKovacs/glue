...
Con i Γˢ = S.Sub {zero} S.∙ {i} Γˢ → Set i

Ty  : ∀ {j}{Γˢ : S.Con j}(Γ : Con j Γˢ) i → S.Ty Γˢ i → Set (suc i ⊔ j)
Ty {j}{Γˢ} Γ i Aˢ = (σ : S.Sub S.∙ {j} Γˢ) → Γ σ → S.Tm S.∙ (Aˢ S.[ σ ]T) → Set i
...
_▶_   : ∀ {i}{Γˢ : S.Con i}(Γ : Con i Γˢ)
          ...
          → Con (i ⊔ j) (Γˢ S.▶ Aˢ)
_▶_ {i}{Γˢ} Γ {j} {Aˢ} A σ = Σ (Γ (S.π₁ σ)) λ σᴾ → A _ σᴾ (S.π₂ σ)

Sub   : ∀ {i}{Γˢ : S.Con i}(Γ : Con i Γˢ)
          {j}{Δˢ : S.Con j}(Δ : Con j Δˢ)
          → S.Sub Γˢ Δˢ → Set (i ⊔ j)
Sub {i} {Γˢ} Γ {j} {Δˢ} Δ σˢ = (σ : S.Sub S.∙ Γˢ) → Γ σ → Δ (σˢ S.∘ σ)

Tm  : ∀ {i}{Γˢ : S.Con i}(Γ : Con i Γˢ)
          {j}{Aˢ : S.Ty Γˢ j}(A : Ty Γ j Aˢ) → S.Tm Γˢ Aˢ → Set (i ⊔ j)
Tm {i} {Γˢ} Γ {j} {Aˢ} A tˢ = (σ : S.Sub S.∙ Γˢ)(σᴾ : Γ σ) → A σ σᴾ (tˢ S.[ σ ]t)
...
_[_]T :
  ∀ {i}{Δˢ : S.Con i}   {Δ : Con i Δˢ}
    ...
    → Ty Γ j (Aˢ S.[ σˢ ]T)
_[_]T {i} {Δˢ} {Δ} {j} {Aˢ} A {k} {Γˢ} {Γ} {σˢ} σ ν νᴾ tˢ = A (σˢ S.∘ ν) (σ ν νᴾ) tˢ
...
_∘_ :
  ...
  → Sub Γ Δ (σˢ S.∘ δˢ)
_∘_ {i} {θˢ} {θ} {j} {Δˢ} {Δ} {σˢ} σ {k} {Γˢ} {Γ} {δˢ} δ ν νᴾ =
  σ (δˢ S.∘ ν) (δ ν νᴾ)

ε : ∀{i}{Γˢ : S.Con i}{Γ : Con i Γˢ} → Sub Γ ∙ S.ε
ε {i}{Γˢ}{Γ} ν νᴾ = tt
...
_,s_ {i}{Γˢ}{Γ}{j}{Δˢ}{Δ}{σˢ} σ {k}{Aˢ}{A}{tˢ} t ν νᴾ =
  (σ ν νᴾ) , t ν νᴾ
...
π₁ :
  ...
  → Sub Γ Δ (S.π₁ σˢ)
π₁ {i}{Γˢ}{Γ}{j}{Δˢ}{Δ}{k}{Aˢ}{A}{σˢ} σ ν νᴾ = ₁ (σ ν νᴾ)
...
_[_]t {A = A} {tˢ} t {σˢ = σˢ} σ ν νᴾ = t (σˢ S.∘ ν) (σ ν νᴾ)
...
wk :
   ...
   Γˢ k} {A : Ty {i} {Γˢ} Γ k Aˢ} → Sub {i ⊔ k} {S._▶_ {i} Γˢ {k} Aˢ}
   (_▶_ {i} {Γˢ} Γ {k} {Aˢ} A) {i} {Γˢ} Γ (S.wk {i} {Γˢ} {k} {Aˢ})
wk {i} {Γˢ} {z₂} {z₃} {z₄} {z₅} ν νᴾ = ₁ νᴾ

vz :
  {i : Level} {Γˢ : S.Con i} {Γ : Con i Γˢ} {k : Level} {Aˢ : S.Ty {i}
  Γˢ k} {A : Ty {i} {Γˢ} Γ k Aˢ} → Tm {i ⊔ k} {S._▶_ {i} Γˢ {k} Aˢ} (_▶_
  {i} {Γˢ} Γ {k} {Aˢ} A) {k} {S._[_]T {i} {Γˢ} {k} Aˢ {i ⊔ k} {S._▶_ {i}
  Γˢ {k} Aˢ} (S.wk {i} {Γˢ} {k} {Aˢ})} (_[_]T {i} {Γˢ} {Γ} {k} {Aˢ} A {i
  ⊔ k} {S._▶_ {i} Γˢ {k} Aˢ} {_▶_ {i} {Γˢ} Γ {k} {Aˢ} A} {S.wk {i} {Γˢ}
  {k} {Aˢ}} (wk {i} {Γˢ} {Γ} {k} {Aˢ} {A})) (S.vz {i} {Γˢ} {k} {Aˢ})
vz {i} {Γˢ} {z₂} {z₃} {z₄} {z₅} ν νᴾ = ₂ νᴾ
...
_^_ {i} {Γˢ} {Γ} {j} {Δˢ} {Δ} {σˢ} σ {k} {Aˢ} A ν νᴾ =
  σ (S.π₁ ν) (νᴾ .₁) , νᴾ .₂
